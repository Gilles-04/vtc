...
| 2 | Audit sécurité complet d'un site web en développement | `02-audit-securite-web.md` | ⏳ À faire |
| 3 | Audit sécurité + configuration Supabase | `03-audit-securite-supabase.md` | ⏳ À faire |

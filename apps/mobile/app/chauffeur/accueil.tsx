...
// Stub — tableau de bord réel (onboarding, documents, abonnement,
// disponibilité, offres, course en cours) déjà construit côté apps/web
// (DriverHome.tsx, TASK-029) : à porter ici une fois l'app mobile sortie
// de sa phase 1 (auth), voir docs/12-roadmap.md.
    ...
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.main}>
        ...
        <Text style={styles.subtitle}>
          Le tableau de bord chauffeur arrive prochainement sur mobile — déjà disponible sur la version web.
        </Text>
      </View>
    </SafeAreaView>
  )

    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-gold-500 text-2xl">
            🚗
          </div>
          <h1 className="text-2xl font-bold text-ink-900">Espace chauffeur</h1>
